...
//                  <ul>
//                     {this.state.currentPage != 1 ? <a href="#" onClick={this.handleClick.bind(this, this.state.currentPage - 1)}><li> less </li></a> : <span> </span>}
//                     {pages}
//                     {this.state.currentPage != this.state.totalPages ?
//                     <a href="#" onClick={this.handleClick.bind(this, this.state.currentPage + 1)}><li> greater </li></a> : <span> </span>}
//                  </ul>
//               </div>
//            </div>
//         </div>
